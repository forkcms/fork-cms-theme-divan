...
<div id="blogDetail">
	...
	{/option:related}
	<div class="inner">
		<p><a href="{$var|geturlforblock:'faq'}" title="{$lblToFaqOverview|ucfirst}"><img src="{$THEME_URL}/core/layout/images/arrow_left.png" alt="left arrow"/>{$lblToFaqOverview|ucfirst}</a></p>
	</div>
